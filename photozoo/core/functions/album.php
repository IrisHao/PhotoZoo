...
//return array albums which is belongs to the user
function get_albums(){
	//albums contain the albums the user has, it is a muldimentional array
	$albums=array();
...
function delete_album($album_id){
	...
	//rmdir() function first delete the files inside the directory and then remove the directory
